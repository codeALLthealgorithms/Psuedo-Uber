...
//
//  Created by Shree Sampath on 8/9/16.
...
class DriverViewController: UITableViewController, CLLocationManagerDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "driverLogoutSegue" {
            ...
            if let destination = segue.destinationViewController as? RiderLocationViewController {
                    ...
                    for riderRequest in riderRequests {
                        ...
                        if let username = riderRequest["username"] as? String {
                            ...
                            if riderRequest["driverResponded"] == nil {
                                ...
                                self.requestLocations.append(CLLocationCoordinate2D(latitude: riderRequest["location"].latitude, longitude: riderRequest["location"].longitude))
